...
ext1 <- c(xmn = -180, xmx = -120)
ext2 <- c(xmn = -119.9999, xmx = -40)
ext3 <- c(xmn = -39.9999, xmx = 0.9999)
ext4 <- c(xmn = 1, xmx = 60.9999)
ext5 <- c(xmn = 61, xmx = 120.9999)
ext6 <- c(xmn = 121, xmx = 180)

r <- raster(ncols = 144, nrows = 72, ymn = -90)

r1 <- raster(ncols = 144, nrows = 72, ymn = -90, xmn = ext1[1], 
             xmx = ext1[2])
r2 <- raster(ncols = 144, nrows = 72, ymn = -90, xmn = ext2[1], 
             xmx = ext2[2])
r3 <- raster(ncols = 144, nrows = 72, ymn = -90, xmn = ext3[1], 
             xmx = ext3[2])
r4 <- raster(ncols = 144, nrows = 72, ymn = -90, xmn = ext4[1], 
             xmx = ext4[2])
r5 <- raster(ncols = 144, nrows = 72, ymn = -90, xmn = ext5[1], 
             xmx = ext5[2])
r6 <- raster(ncols = 144, nrows = 72, ymn = -90, xmn = ext6[1], 
             xmx = ext6[2])

writeRaster(r, "/Volumes/Personal/lab/spp_ages/amphibia/raster1/r.tif",
            format = "GTiff")

writeRaster(r1, 
            "/Volumes/Personal/lab/spp_ages/amphibia/raster1/ext1/r1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/amphibia/raster1", 
        extent(ext1, -90, 90),
        "/Volumes/Personal/lab/spp_ages/amphibia/raster1/ext1", log = F)

writeRaster(r2, 
            "/Volumes/Personal/lab/spp_ages/amphibia/raster1/ext2/r2.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/amphibia/raster1", 
        extent(ext2, -90, 90),
        "/Volumes/Personal/lab/spp_ages/amphibia/raster1/ext2", log = F)

writeRaster(r3, 
            "/Volumes/Personal/lab/spp_ages/amphibia/raster1/ext3/r3.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/amphibia/raster1", 
        extent(ext3, -90, 90),
        "/Volumes/Personal/lab/spp_ages/amphibia/raster1/ext3", log = F)

writeRaster(r4, 
            "/Volumes/Personal/lab/spp_ages/amphibia/raster1/ext4/r4.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/amphibia/raster1", 
        extent(ext4, -90, 90),
        "/Volumes/Personal/lab/spp_ages/amphibia/raster1/ext4", log = F)

writeRaster(r5, 
            "/Volumes/Personal/lab/spp_ages/amphibia/raster1/ext5/r5.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/amphibia/raster1", 
        extent(ext5, -90, 90),
        "/Volumes/Personal/lab/spp_ages/amphibia/raster1/ext5", log = F)

writeRaster(r6, 
            "/Volumes/Personal/lab/spp_ages/amphibia/raster1/ext6/r6.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/amphibia/raster1", 
        extent(ext6, -90, 90),
        "/Volumes/Personal/lab/spp_ages/amphibia/raster1/ext6", log = F)


r_2 <- raster(ncols = 360, nrows = 149, ymn = -65)

r1_2 <- raster(ncols = 360, nrows = 149, ymn = -65, xmn = ext1[1], 
               xmx = ext1[2])
r2_2 <- raster(ncols = 360, nrows = 149, ymn = -65, xmn = ext2[1], 
               xmx = ext2[2])
r3_2 <- raster(ncols = 360, nrows = 149, ymn = -65, xmn = ext3[1], 
               xmx = ext3[2])
r4_2 <- raster(ncols = 360, nrows = 149, ymn = -65, xmn = ext4[1], 
               xmx = ext4[2])
r5_2 <- raster(ncols = 360, nrows = 149, ymn = -65, xmn = ext5[1], 
               xmx = ext5[2])
r6_2 <- raster(ncols = 360, nrows = 149, ymn = -65, xmn = ext6[1], 
               xmx = ext6[2])

writeRaster(r_2, "/Volumes/Personal/lab/spp_ages/amphibia/raster2/r.tif",
            format = "GTiff")

writeRaster(r1_2, 
            "/Volumes/Personal/lab/spp_ages/amphibia/raster2/ext1/r1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/amphibia/raster2", 
        extent(ext1, -65, 90),
        "/Volumes/Personal/lab/spp_ages/amphibia/raster2/ext1", log = F)

writeRaster(r2_2, 
            "/Volumes/Personal/lab/spp_ages/amphibia/raster2/ext2/r2.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/amphibia/raster2", 
        extent(ext2, -65, 90),
        "/Volumes/Personal/lab/spp_ages/amphibia/raster2/ext2", log = F)

writeRaster(r3_2, 
            "/Volumes/Personal/lab/spp_ages/amphibia/raster2/ext3/r3.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/amphibia/raster2", 
        extent(ext3, -65, 90),
        "/Volumes/Personal/lab/spp_ages/amphibia/raster2/ext3", log = F)

writeRaster(r4_2, 
            "/Volumes/Personal/lab/spp_ages/amphibia/raster2/ext4/r4.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/amphibia/raster2", 
        extent(ext4, -65, 90),
        "/Volumes/Personal/lab/spp_ages/amphibia/raster2/ext4", log = F)

writeRaster(r5_2, 
            "/Volumes/Personal/lab/spp_ages/amphibia/raster2/ext5/r5.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/amphibia/raster2", 
        extent(ext5, -65, 90),
        "/Volumes/Personal/lab/spp_ages/amphibia/raster2/ext5", log = F)

writeRaster(r6_2, 
            "/Volumes/Personal/lab/spp_ages/amphibia/raster2/ext6/r6.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/amphibia/raster2", 
        extent(ext6, -65, 90),
        "/Volumes/Personal/lab/spp_ages/amphibia/raster2/ext6", log = F)


writeRaster(r, "/Volumes/Personal/lab/spp_ages/squamata/raster1/r.tif",
            format = "GTiff")

writeRaster(r1, 
            "/Volumes/Personal/lab/spp_ages/squamata/raster1/ext1/r1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/squamata/raster1", 
        extent(ext1, -90, 90),
        "/Volumes/Personal/lab/spp_ages/squamata/raster1/ext1", log = F)

writeRaster(r2, 
            "/Volumes/Personal/lab/spp_ages/squamata/raster1/ext2/r2.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/squamata/raster1", 
        extent(ext2, -90, 90),
        "/Volumes/Personal/lab/spp_ages/squamata/raster1/ext2", log = F)

writeRaster(r3, 
            "/Volumes/Personal/lab/spp_ages/squamata/raster1/ext3/r3.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/squamata/raster1", 
        extent(ext3, -90, 90),
        "/Volumes/Personal/lab/spp_ages/squamata/raster1/ext3", log = F)

writeRaster(r4, 
            "/Volumes/Personal/lab/spp_ages/squamata/raster1/ext4/r4.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/squamata/raster1", 
        extent(ext4, -90, 90),
        "/Volumes/Personal/lab/spp_ages/squamata/raster1/ext4", log = F)

writeRaster(r5, 
            "/Volumes/Personal/lab/spp_ages/squamata/raster1/ext5/r5.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/squamata/raster1", 
        extent(ext5, -90, 90),
        "/Volumes/Personal/lab/spp_ages/squamata/raster1/ext5", log = F)

writeRaster(r6, 
            "/Volumes/Personal/lab/spp_ages/squamata/raster1/ext6/r6.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/squamata/raster1", 
        extent(ext6, -90, 90),
        "/Volumes/Personal/lab/spp_ages/squamata/raster1/ext6", log = F)


writeRaster(r_2, "/Volumes/Personal/lab/spp_ages/squamata/raster2/r.tif",
            format = "GTiff")

writeRaster(r1_2, 
            "/Volumes/Personal/lab/spp_ages/squamata/raster2/ext1/r1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/squamata/raster2", 
        extent(ext1, -65, 90),
        "/Volumes/Personal/lab/spp_ages/squamata/raster2/ext1", log = F)

writeRaster(r2_2, 
            "/Volumes/Personal/lab/spp_ages/squamata/raster2/ext2/r2.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/squamata/raster2", 
        extent(ext2, -65, 90),
        "/Volumes/Personal/lab/spp_ages/squamata/raster2/ext2", log = F)

writeRaster(r3_2, 
            "/Volumes/Personal/lab/spp_ages/squamata/raster2/ext3/r3.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/squamata/raster2", 
        extent(ext3, -65, 90),
        "/Volumes/Personal/lab/spp_ages/squamata/raster2/ext3", log = F)

writeRaster(r4_2, 
            "/Volumes/Personal/lab/spp_ages/squamata/raster2/ext4/r4.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/squamata/raster2", 
        extent(ext4, -65, 90),
        "/Volumes/Personal/lab/spp_ages/squamata/raster2/ext4", log = F)

writeRaster(r5_2, 
            "/Volumes/Personal/lab/spp_ages/squamata/raster2/ext5/r5.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/squamata/raster2", 
        extent(ext5, -65, 90),
        "/Volumes/Personal/lab/spp_ages/squamata/raster2/ext5", log = F)

writeRaster(r6_2, 
            "/Volumes/Personal/lab/spp_ages/squamata/raster2/ext6/r6.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/squamata/raster2", 
        extent(ext6, -65, 90),
        "/Volumes/Personal/lab/spp_ages/squamata/raster2/ext6", log = F)


ext2.1 <- c(xmn = -119.9999, xmx = -80)
ext2.2 <- c(xmn = -79.9999, xmx = -60)
ext3.1 <- c(xmn = -59.9999, xmx = -20)
ext3.2 <- c(xmn = -19.9999, xmx = 20.9999)
ext4.1 <- c(xmn = 21, xmx = 40.9999)
ext4.2 <- c(xmn = 41, xmx = 60.9999)
ext5.1 <- c(xmn = 61, xmx = 90.9999)
ext5.2 <- c(xmn = 91, xmx = 120.9999)
ext6.1 <- c(xmn = 121, xmx = 150.9999)
ext6.2 <- c(xmn = 151, xmx = 180)

r2.1 <- raster(ncols = 144, nrows = 72, ymn = -90, xmn = ext2.1[1], 
             xmx = ext2.1[2])
r2.2 <- raster(ncols = 144, nrows = 72, ymn = -90, xmn = ext2.2[1], 
             xmx = ext2.2[2])
r3.1 <- raster(ncols = 144, nrows = 72, ymn = -90, xmn = ext3.1[1], 
             xmx = ext3.1[2])
r3.2 <- raster(ncols = 144, nrows = 72, ymn = -90, xmn = ext3.2[1], 
             xmx = ext3.2[2])
r4.1 <- raster(ncols = 144, nrows = 72, ymn = -90, xmn = ext4.1[1], 
             xmx = ext4.1[2])
r4.2 <- raster(ncols = 144, nrows = 72, ymn = -90, xmn = ext4.2[1], 
             xmx = ext4.2[2])
r5.1 <- raster(ncols = 144, nrows = 72, ymn = -90, xmn = ext5.1[1], 
             xmx = ext5.1[2])
r5.2 <- raster(ncols = 144, nrows = 72, ymn = -90, xmn = ext5.2[1], 
             xmx = ext5.2[2])
r6.1 <- raster(ncols = 144, nrows = 72, ymn = -90, xmn = ext6.1[1], 
             xmx = ext6.1[2])
r6.2 <- raster(ncols = 144, nrows = 72, ymn = -90, xmn = ext6.2[1], 
             xmx = ext6.2[2])

writeRaster(r, "/Volumes/Personal/lab/spp_ages/aves/raster1/r.tif",
            format = "GTiff")

writeRaster(r1, 
            "/Volumes/Personal/lab/spp_ages/aves/raster1/ext1/r1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster1", 
        extent(ext1, -90, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster1/ext1", log = F)

writeRaster(r2.1, 
            "/Volumes/Personal/lab/spp_ages/aves/raster1/ext2.1/r2.1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster1", 
        extent(ext2.1, -90, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster1/ext2.1", log = F)

writeRaster(r2.2, 
            "/Volumes/Personal/lab/spp_ages/aves/raster1/ext2.2/r2.2.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster1", 
        extent(ext2.2, -90, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster1/ext2.2", log = F)

writeRaster(r3.1, 
            "/Volumes/Personal/lab/spp_ages/aves/raster1/ext3.1/r3.1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster1", 
        extent(ext3.1, -90, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster1/ext3.1", log = F)

writeRaster(r3.2, 
            "/Volumes/Personal/lab/spp_ages/aves/raster1/ext3.2/r3.2.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster1", 
        extent(ext3.2, -90, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster1/ext3.2", log = F)

writeRaster(r4.1, 
            "/Volumes/Personal/lab/spp_ages/aves/raster1/ext4.1/r4.1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster1", 
        extent(ext4.1, -90, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster1/ext4.1", log = F)

writeRaster(r4.2, 
            "/Volumes/Personal/lab/spp_ages/aves/raster1/ext4.2/r4.2.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster1", 
        extent(ext4.2, -90, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster1/ext4.2", log = F)

writeRaster(r5.1, 
            "/Volumes/Personal/lab/spp_ages/aves/raster1/ext5.1/r5.1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster1", 
        extent(ext5.1, -90, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster1/ext5.1", log = F)

writeRaster(r5.2, 
            "/Volumes/Personal/lab/spp_ages/aves/raster1/ext5.2/r5.2.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster1", 
        extent(ext5.2, -90, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster1/ext5.2", log = F)

writeRaster(r6.1, 
            "/Volumes/Personal/lab/spp_ages/aves/raster1/ext6.1/r6.1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster1", 
        extent(ext6.1, -90, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster1/ext6.1", log = F)

writeRaster(r6.2, 
            "/Volumes/Personal/lab/spp_ages/aves/raster1/ext6.2/r6.2.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster1", 
        extent(ext6.2, -90, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster1/ext6.2", log = F)

r2.1_2 <- raster(ncols = 360, nrows = 149, ymn = -65, xmn = ext2.1[1], 
             xmx = ext2.1[2])
r2.2_2 <- raster(ncols = 360, nrows = 149, ymn = -65, xmn = ext2.2[1], 
             xmx = ext2.2[2])
r3.1_2 <- raster(ncols = 360, nrows = 149, ymn = -65, xmn = ext3.1[1], 
             xmx = ext3.1[2])
r3.2_2 <- raster(ncols = 360, nrows = 149, ymn = -65, xmn = ext3.2[1], 
             xmx = ext3.2[2])
r4.1_2 <- raster(ncols = 360, nrows = 149, ymn = -65, xmn = ext4.1[1], 
             xmx = ext4.1[2])
r4.2_2 <- raster(ncols = 360, nrows = 149, ymn = -65, xmn = ext4.2[1], 
             xmx = ext4.2[2])
r5.1_2 <- raster(ncols = 360, nrows = 149, ymn = -65, xmn = ext5.1[1], 
             xmx = ext5.1[2])
r5.2_2 <- raster(ncols = 360, nrows = 149, ymn = -65, xmn = ext5.2[1], 
             xmx = ext5.2[2])
r6.1_2 <- raster(ncols = 360, nrows = 149, ymn = -65, xmn = ext6.1[1], 
             xmx = ext6.1[2])
r6.2_2 <- raster(ncols = 360, nrows = 149, ymn = -65, xmn = ext6.2[1], 
             xmx = ext6.2[2])

writeRaster(r_2, "/Volumes/Personal/lab/spp_ages/aves/raster2/r.tif",
            format = "GTiff")

writeRaster(r1_2, 
            "/Volumes/Personal/lab/spp_ages/aves/raster2/ext1/r1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster2", 
        extent(ext1, -65, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster2/ext1", log = F)

writeRaster(r2.1_2, 
            "/Volumes/Personal/lab/spp_ages/aves/raster2/ext2.1/r2.1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster2", 
        extent(ext2.1, -65, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster2/ext2.1", log = F)

writeRaster(r2.2_2, 
            "/Volumes/Personal/lab/spp_ages/aves/raster2/ext2.2/r2.2.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster2", 
        extent(ext2.2, -65, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster2/ext2.2", log = F)

writeRaster(r3.1_2, 
            "/Volumes/Personal/lab/spp_ages/aves/raster2/ext3.1/r3.1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster2", 
        extent(ext3.1, -65, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster2/ext3.1", log = F)

writeRaster(r3.2_2, 
            "/Volumes/Personal/lab/spp_ages/aves/raster2/ext3.2/r3.2.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster2", 
        extent(ext3.2, -65, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster2/ext3.2", log = F)

writeRaster(r4.1_2, 
            "/Volumes/Personal/lab/spp_ages/aves/raster2/ext4.1/r4.1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster2", 
        extent(ext4.1, -65, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster2/ext4.1", log = F)

writeRaster(r4.2_2, 
            "/Volumes/Personal/lab/spp_ages/aves/raster2/ext4.2/r4.2.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster2", 
        extent(ext4.2, -65, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster2/ext4.2", log = F)

writeRaster(r5.1_2, 
            "/Volumes/Personal/lab/spp_ages/aves/raster2/ext5.1/r5.1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster2", 
        extent(ext5.1, -65, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster2/ext5.1", log = F)

writeRaster(r5.2_2, 
            "/Volumes/Personal/lab/spp_ages/aves/raster2/ext5.2/r5.2.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster2", 
        extent(ext5.2, -65, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster2/ext5.2", log = F)

writeRaster(r6.1_2, 
            "/Volumes/Personal/lab/spp_ages/aves/raster2/ext6.1/r6.1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster2", 
        extent(ext6.1, -65, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster2/ext6.1", log = F)

writeRaster(r6.2_2, 
            "/Volumes/Personal/lab/spp_ages/aves/raster2/ext6.2/r6.2.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/aves/raster2", 
        extent(ext6.2, -65, 90),
        "/Volumes/Personal/lab/spp_ages/aves/raster2/ext6.2", log = F)


writeRaster(r, "/Volumes/Personal/lab/spp_ages/mammalia/raster1/r.tif",
            format = "GTiff")

writeRaster(r1, 
            "/Volumes/Personal/lab/spp_ages/mammalia/raster1/ext1/r1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/mammalia/raster1", 
        extent(ext1, -90, 90),
        "/Volumes/Personal/lab/spp_ages/mammalia/raster1/ext1", log = F)

writeRaster(r2, 
            "/Volumes/Personal/lab/spp_ages/mammalia/raster1/ext2/r2.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/mammalia/raster1", 
        extent(ext2, -90, 90),
        "/Volumes/Personal/lab/spp_ages/mammalia/raster1/ext2", log = F)

writeRaster(r3, 
            "/Volumes/Personal/lab/spp_ages/mammalia/raster1/ext3/r3.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/mammalia/raster1", 
        extent(ext3, -90, 90),
        "/Volumes/Personal/lab/spp_ages/mammalia/raster1/ext3", log = F)

writeRaster(r4, 
            "/Volumes/Personal/lab/spp_ages/mammalia/raster1/ext4/r4.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/mammalia/raster1", 
        extent(ext4, -90, 90),
        "/Volumes/Personal/lab/spp_ages/mammalia/raster1/ext4", log = F)

writeRaster(r5, 
            "/Volumes/Personal/lab/spp_ages/mammalia/raster1/ext5/r5.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/mammalia/raster1", 
        extent(ext5, -90, 90),
        "/Volumes/Personal/lab/spp_ages/mammalia/raster1/ext5", log = F)

writeRaster(r6, 
            "/Volumes/Personal/lab/spp_ages/mammalia/raster1/ext6/r6.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/mammalia/raster1", 
        extent(ext6, -90, 90),
        "/Volumes/Personal/lab/spp_ages/mammalia/raster1/ext6", log = F)


writeRaster(r_2, "/Volumes/Personal/lab/spp_ages/mammalia/raster2/r.tif",
            format = "GTiff")

writeRaster(r1_2, 
            "/Volumes/Personal/lab/spp_ages/mammalia/raster2/ext1/r1.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/mammalia/raster2", 
        extent(ext1, -65, 90),
        "/Volumes/Personal/lab/spp_ages/mammalia/raster2/ext1", log = F)

writeRaster(r2_2, 
            "/Volumes/Personal/lab/spp_ages/mammalia/raster2/ext2/r2.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/mammalia/raster2", 
        extent(ext2, -65, 90),
        "/Volumes/Personal/lab/spp_ages/mammalia/raster2/ext2", log = F)

writeRaster(r3_2, 
            "/Volumes/Personal/lab/spp_ages/mammalia/raster2/ext3/r3.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/mammalia/raster2", 
        extent(ext3, -65, 90),
        "/Volumes/Personal/lab/spp_ages/mammalia/raster2/ext3", log = F)

writeRaster(r4_2, 
            "/Volumes/Personal/lab/spp_ages/mammalia/raster2/ext4/r4.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/mammalia/raster2", 
        extent(ext4, -65, 90),
        "/Volumes/Personal/lab/spp_ages/mammalia/raster2/ext4", log = F)

writeRaster(r5_2, 
            "/Volumes/Personal/lab/spp_ages/mammalia/raster2/ext5/r5.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/mammalia/raster2", 
        extent(ext5, -65, 90),
        "/Volumes/Personal/lab/spp_ages/mammalia/raster2/ext5", log = F)

writeRaster(r6_2, 
            "/Volumes/Personal/lab/spp_ages/mammalia/raster2/ext6/r6.tif",
            format = "GTiff")
crop_rg("/Volumes/Personal/lab/spp_ages/mammalia/raster2", 
        extent(ext6, -65, 90),
        "/Volumes/Personal/lab/spp_ages/mammalia/raster2/ext6", log = F)

###### Processing that data on QGIS to get average values of ages per cell
